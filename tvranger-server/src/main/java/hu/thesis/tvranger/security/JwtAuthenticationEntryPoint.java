...
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
  ...
  @Override public void commence(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, AuthenticationException e) throws IOException, ServletException {
    logger.error("Unauthorized response. Message - {}", e.getMessage());

    httpServletResponse.sendError(HttpServletResponse.SC_UNAUTHORIZED, "Unfortunately you are not authorized to access this resource");
